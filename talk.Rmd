...
-   Reduces overfitting, memory, and therefore speeds up the fitting process
...
- The training is done using \textbf{G}raphics \textbf{P}rocessing \textbf{U}nits and a special programming language called __CUDA__.
...
CUDA is a very _low level_ programming language and thus writing code for deeplearning requires a lot of work.
...
- Open-source high-level API for deeplearning.
